...
//! a serialized [`PregenState`](./struct.PregenState.html) every 512 chunks
//! generated (if the server accepts a `save-all flush` command and runs it
//! successfully). In other words, if you stop the server wrapper to, for
//! example, to adjust the configuration, it will not attempt to regenerate the
//! whole world.
//!
